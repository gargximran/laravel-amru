            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add_supllier" method="POST" action="">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Name <span class="text-danger">*</span></label>
                                        <input class="form-control" id="sup_name" name="sup_name" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Phone</label>
                                        <input class="form-control" id="sup_phone" name="phone" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="sup_email"  name="sup_email" type="email">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="col-form-label">Image <span class="text-danger">*</span></label>
                                        <input class="form-control" id="image" name="sup_image" type="file">
                                    </div>
                                </div>
...
<script>
    ...
    //                 div=div+"<a href='{{URL::to('/admin/supplier/view')}}/'"+value.id+" class='avatar'>"
    //                 div=div+"<img src=http://localhost/amru/public/images/"+value.image+" height='81px' width='40px' >"
                       
    //                 div=div+"</a></div>";
    //                 div=div+" <h4 class='user-name m-t-10 mb-0 text-ellipsis'><a href='profile.html'>"+value.sup_name+"</a></h4>";
    ...
    // viewData();
        ...
        $(function(){
            ...
            $('#add_supllier').on('submit',function(e){
                e.preventDefault();
    ...
    function deleteData(id){
        ...
        $.ajax({
            type:"get",
            dataType:"json",
            url:"{{URL::to('/admin/supplier/delete/')}}"+'/'+id,
            success:function(response){
                Toast.fire({
                        type: 'success',
